...
st.title("Ahoj Streamlit!")
st.write(
    "Toto je moja prva aplikacia v Streamlite"
)
...
fig = px.bar(data, x = "Kategorie", y = "Hodnoty", title = "Stlpcovy graf plotly")

st.plotly_chart(fig)

if st.button("Informacne okna"):
...
fig_bar = px.bar(edited_data, x = "Kategorie", y = "Hodnoty", title = "Upraveny Stlpcovy graf plotly")

st.plotly_chart(fig_bar)

st.write("Kolacovy graf:")
fig_pie = px.pie(edited_data, names = "Kategorie", values = "Hodnoty", title = "Upraveny kolacovy graf plotly")
